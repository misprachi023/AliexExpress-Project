...
import {
  ...
  export default function MidFooter() {
    return (
      <>
        <Flex justifyContent={"space-around"}backgroundColor={"#F0FFFF"} padding={"20px"}>
          <Box>
            <UnorderedList listStyleType={"none"} lineHeight={"25px"} >
              <Text fontWeight={"bold"} padding={"10px"}>True Wireless Earbuds</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>True Wireless Earbuds Wireless Headphone</ListItem>
              <ListItem color={"gray"}>Wired Headphones Wireless Speakers</ListItem>
              <ListItem color={"gray"}>Home Audio Moblie Accessories</ListItem>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Price</Text>
              ...
              <Text fontWeight={"bold"} padding={"10px"}> Wired Earphones</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>True Wireless Earbuds Wireless Headphone</ListItem>
              <ListItem color={"gray"}>Wired Headphones Wireless Speakers</ListItem>
              <ListItem color={"gray"}>Home Audio Moblie Accessories</ListItem>
              ...
              <Text fontWeight={"bold"} padding={"10px"}>Gaming Headphones</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>True Wireless Earbuds Wireless Headphone</ListItem>
              <ListItem color={"gray"}>Wired Headphones Wireless Speakers</ListItem>
              <ListItem color={"gray"}>Home Audio Moblie Accessories</ListItem>
          ...
          <Box>
            <UnorderedList listStyleType={"none"} lineHeight={"25px"}>
              <Text fontWeight={"bold"} padding={"10px"}>Wireless Speakers</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              ...
              <Text fontWeight={"bold"} padding={"10px"}>Soundbars</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>Track Your Order</ListItem>
              <ListItem color={"gray"}>Warranty & Support</ListItem>
              <ListItem color={"gray"}>Return Policy</ListItem>
              ...
              <Text fontWeight={"bold"} padding={"10px"}>Smart Watches</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>Track Your Order</ListItem>
              <ListItem color={"gray"}>Warranty & Support</ListItem>
              <ListItem color={"gray"}>Return Policy</ListItem>
              ...
              <Text fontWeight={"bold"} padding={"10px"}>Trimmers</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>Track Your Order</ListItem>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Price</Text>
              <ListItem color={"gray"}>Bluetooth Speakers Under 1000</ListItem>
          ...
          <Box>
            <UnorderedList listStyleType={"none"} lineHeight={"25px"}>
              <Text fontWeight={"bold"} padding={"10px"}>Limited Editions</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>About boAt</ListItem>
              <ListItem color={"gray"}>News</ListItem>
              <ListItem color={"gray"}>Read Our Blog</ListItem>
              <Text padding={"10px"} fontWeight={"bold"} >Car Accessories</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Featues</Text>
              ...
              <Text padding={"10px"} fontWeight={"bold"} >Trebel Range</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Featues</Text>
              <ListItem color={"gray"}>Careers</ListItem>
              <ListItem color={"gray"}>Security</ListItem>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Price</Text>
              ...
              <Text fontWeight={"bold"} padding={"10px"}>PowerBanks</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>Track Your Order</ListItem>
              <ListItem color={"gray"}>Warranty & Support</ListItem>
              <ListItem color={"gray"}>Return Policy</ListItem>
              ...
              <Text fontWeight={"bold"} padding={"10px"}>Charges</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
              <ListItem color={"gray"}>Track Your Order</ListItem>
              <ListItem color={"gray"}>Warranty & Support</ListItem>
              <ListItem color={"gray"}>Return Policy</ListItem>
          ...
          <Box>
            <UnorderedList listStyleType={"none"} lineHeight={"25px"}>
              <Text fontWeight={"bold"} padding={"10px"}>Cables</Text>
              <Text padding={"10px"} fontWeight={"500"}>Shop by Feautes</Text>
