  ...
  const breakpoint={
    ...
    return (
        ...
        <>
            ...
            >
                <SwiperSlide  >
        <Box width={breakpoint} overflow={"hidden"}   borderRadius={"10px"}  objectFit={"cover"} >
           
         
          <HoverVideoPlayer videoSrc="https://www.boat-lifestyle.com/cdn/shop/files/quinn_RUxbhR7CvjkNtlFUDxgw9.mp4" />
          </Box>
          <Text textAlign={"center"} fontWeight={"bold"}>Smartwatches</Text>
