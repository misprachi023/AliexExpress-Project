...
export default function Footer() {
  return (
    <>
      <Flex flexWrap={"wrap"} justifyContent={"space-around"} backgroundColor={"#E7F0F5"} padding={"20px"}>
        <Box>
          <Box margin={"10px"}>
            <img
          ...
          <Text fontWeight={"bold"} fontSize={"30px"} lineHeight={"30px"} margin={"10px"}>
            Subscribe to our email <br />
            alerts!
          </Text>
          <FormControl padding={"20px"} >
            <Input type="email" padding={"25px"} width={"auto"} backgroundColor={"white"} placeholder="Enter your email address" />
          </FormControl>
        </Box>
        <Box>
          <UnorderedList listStyleType={"none"} lineHeight={"40px"}>
            ...
            <ListItem>Samrt Watches TRebel</ListItem>
